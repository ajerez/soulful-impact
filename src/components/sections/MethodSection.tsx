...
const lines = [
  ...
  { text: "Concepto antes que estética. Narrativa antes que decoración.", size: "text-lg md:text-2xl" },
  { text: "Ejecución impecable.", size: "font-heading text-3xl md:text-5xl lg:text-6xl" },
  { text: "No es perfeccionismo. Es respeto por el resultado.", size: "text-lg md:text-2xl" },
];
  ...
  return (
    <section className="min-h-[110dvh] flex flex-col items-center justify-center px-6 md:px-12 py-24 gap-10 md:gap-14">
      ...
      <motion.p
        ...
        className="text-lg md:text-2xl text-center max-w-4xl leading-relaxed mt-8"
      >
